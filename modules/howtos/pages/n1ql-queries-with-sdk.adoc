...
From version 3.0.4 of the C SDK, it is possible to query off the xref:7.0@server:learn:data/scopes-and-collections.adoc[`Scope` level] _with Couchbase Server 7.0_,
