...
Batching examples are given for https://github.com/couchbase/docs-sdk-c/blob/release/3.0/modules/devguide/examples/c/bulk-store.cc[bulk store] and for https://github.com/couchbase/docs-sdk-c/blob/release/3.0/modules/devguide/examples/c/bulk-get.cc[bulk get].
