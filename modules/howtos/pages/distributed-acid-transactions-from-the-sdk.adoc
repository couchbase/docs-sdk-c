...
[source,c++]
----
include::example$transactions-example.cxx[tag=imports,indent=0]
----
...
[source,c++]
----
include::example$transactions-example.cxx[tag=createReactive,indent=0]
----
...
[source,c++]
----
include::example$transactions-example.cxx[tag=examplesReactive,indent=0]
----
...
[source,c++]
----
include::example$transactions-example.cxx[tag=replaceReactive,indent=0]
----
...
[source,c++]
----
include::example$transactions-example.cxx[tag=removeReactive,indent=0]
----
...
.With the synchronous API:
----
include::example$transactions-example.cxx[tag=insertReactive,indent=0]
----
...
[source,c++]
----
include::example$transactions-example.cxx[tag=rollback-cause,indent=0]
----
...
[source,c++]
----
include::example$transactions-example.cxx[tag=cleanup-events,indent=0]
----
...
[source,c++]
----
include::example$transactions-example.cxx[tag=concurrentOps,indent=0]
----
