...
* Couchbase C client 3.0.6 or above.  It is recommended to follow the transitive dependency for the transactions library from maven.
...
The latest version, as of October 2020, is 1.0.0-β.
