...
[source,c]
----
include::example$subdoc-retrieving.cc[tag=sub-doc-exists,indent=0]
----

.Retrieve Subdocument value
[source,c]
----
include::example$subdoc-retrieving.cc[tag=sub-doc-retrieve,indent=0]
----
////
...
[source,c]
----
include::example$insert-upsert.cc[tag=upsert,indent=0]
----
...
[source,c]
----
include::example$insert-upsert.cc[tag=async,indent=0]
----
...
[source,c]
----
include::example$subdoc-updating.cc[tag=sub-doc-mutate,indent=0]
----
...
[source,c]
----
include::example$array-append-prepend.cc[tag=concurrent,indent=0]
----
Even when modifying the same part of the document, operations will not necessarily conflict. For example, two concurrent `lcb_subdocspecs_array_add_first` and `lcb_subdocspecs_array_add_unique` will both succeed.
...
[source,c]
----
include::example$durability.cc[tag=subdoc-durability,indent=0]
----
