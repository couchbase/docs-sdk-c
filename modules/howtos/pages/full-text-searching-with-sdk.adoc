...
For a full Search example, see the {lcb_api_link}/example_2fts_2fts_8c-example.html[API documentation].
...
Couchbase FTS's xref:{version-common}@server:fts:fts-query-types.adoc[range of query types] enable powerful searching using multiple options, to ensure results are just within the range wanted.
