...
Common use cases are outlined here, more recherché use cases are covered in the https://docs.couchbase.com/sdk-api/couchbase-c-client/[API docs].
...
It is instantiated through the `lcb_create()`  method -- see the bucket creation example https://github.com/couchbase/docs-sdk-c/blob/release/3.1/modules/devguide/examples/c/management-bucket-create.cc[here].

And the https://github.com/couchbase/docs-sdk-c/blob/release/3.1/modules/devguide/examples/c/management-bucket-drop.cc[dropping bucket example].
...
You can flush a bucket in the SDK by using the https://docs.couchbase.com/sdk-api/couchbase-c-client/group__lcb-flush.html[`lcb_cbflush3()` method].
...
See the example https://github.com/couchbase/docs-sdk-c/blob/release/3.1/modules/devguide/examples/c/management-bucket-flush.cc[here].
