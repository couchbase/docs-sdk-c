...
It is instantiated through the `lcb_create()`  method -- see the bucket creation example https://github.com/couchbase/docs-sdk-c/blob/release/3.0/modules/devguide/examples/c/management-bucket-create.cc[here].

And the https://github.com/couchbase/docs-sdk-c/blob/release/3.0/modules/devguide/examples/c/management-bucket-drop.cc[dropping bucket example].
...
See the example https://github.com/couchbase/docs-sdk-c/blob/release/3.0/modules/devguide/examples/c/management-bucket-flush.cc[here].
