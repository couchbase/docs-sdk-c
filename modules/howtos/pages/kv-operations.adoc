...
See the https://github.com/couchbase/docs-sdk-c/blob/release/3.2/modules/devguide/examples/c/retrieving.cc[code sample^] for use in context.
...
See the https://github.com/couchbase/docs-sdk-c/blob/release/3.2/modules/devguide/examples/c/cas.cc[code sample^] for use in context.
////
...
----
See the https://github.com/couchbase/docs-sdk-c/blob/release/3.2/modules/devguide/examples/c/durability.cc[code sample^] for use in context.
...
See the https://github.com/couchbase/docs-sdk-c/blob/release/3.2/modules/devguide/examples/c/expiration.cc[code sample^] for use in context.
...
See the https://github.com/couchbase/docs-sdk-c/blob/release/3.2/modules/devguide/examples/c/counter.cc[code sample^] for use in context.
