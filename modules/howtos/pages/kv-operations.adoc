...
[source,c]
----
include::example$insert-upsert.c[tag=insert]
----
...
[source,c]
----
include::example$insert-upsert.c[tag=retrieve]
----
== Replace
...
[source,c]
----
include::example$durability.c[tag=durability]
----
...
[source,c]
----
include::example$expiration.c[tag=expiration]
----
////
...
[source,c]
----
include::example$atomic-counters.c[tag=atomic-counter]
----
////
.Increment
[source,csharp]
