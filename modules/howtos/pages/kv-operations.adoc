...
See the code sample at https://github.com/couchbase/docs-sdk-c/blob/release/3.0/modules/devguide/examples/c/retrieving.cc^ for use in context.
////
...
See the code sample at https://github.com/couchbase/docs-sdk-c/blob/release/3.0/modules/devguide/examples/c/cas.cc^ for use in context.
////
...
----
////
See the code sample at https://github.com/couchbase/docs-sdk-c/blob/release/3.0/modules/devguide/examples/c/durability.cc^ for use in context.
...
See the code sample at https://github.com/couchbase/docs-sdk-c/blob/release/3.0/modules/devguide/examples/c/expiration.cc^ for use in context.
...
See the code sample at https://github.com/couchbase/docs-sdk-c/blob/release/3.0/modules/devguide/examples/c/counter.cc^ for use in context.
