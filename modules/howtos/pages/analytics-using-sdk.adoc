...
include::7.2@sdk:shared:partial$columnar-available.adoc[tag=initial-availability]

For complex and long-running queries, involving large ad hoc join, set, aggregation, and grouping operations, Couchbase Data Platform offers the xref:7.2@server:analytics:introduction.adoc[Couchbase Analytics Service (CBAS)].
