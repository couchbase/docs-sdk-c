...
A fully worked example can be found https://github.com/couchbase/docs-sdk-c/blob/release/3.2/modules/devguide/examples/c/cas.cc[here^] and
https://github.com/couchbase/docs-sdk-c/blob/release/3.2/modules/devguide/examples/c/pessimistic-lock.cc[here^].
