...
For more information on `lcb_diag()` and `lcb_PING_SERVICE`, refer to the https://docs.couchbase.com/sdk-api/couchbase-c-client/group__lcb-ping.html[API documentation].
