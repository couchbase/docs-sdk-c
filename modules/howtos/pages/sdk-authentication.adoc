...
For sample procedures whereby certificates can be generated and deployed, see xref:{version-common}@server:manage:manage-security/manage-certificates.adoc[Manage Certificates].
