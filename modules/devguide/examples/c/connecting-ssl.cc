...
int
main(int, char **) {
    // This connection string assumes you copy-and-paste the certificate from the server into a file named
    // `../cluster.cert` in the parent directory of the `build` directory (where the executable will be).
    //
