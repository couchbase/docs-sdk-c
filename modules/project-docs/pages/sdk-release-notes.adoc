...
* https://issues.couchbase.com/browse/CCBC-1350[CCBC-1350]:
  Implement an option for cbc-n1ql to control prepared/adhoc switch
...
* https://issues.couchbase.com/browse/CCBC-1348[CCBC-1348]:
  Include bucket name into diag report

* https://issues.couchbase.com/browse/CCBC-1308[CCBC-1308]:
  Define FATAL and TRANSIENT classes for errors. Also defines corresponding macros for easy access `LCB_ERROR_IS_TRANSIENT` and `LCB_ERROR_IS_FATAL`
...
* https://issues.couchbase.com/browse/CCBC-1339[CCBC-1339]:
  Do not relocate get with replica on failover. The library should not relocate replica reads when new configuration applied.
...
* https://issues.couchbase.com/browse/CCBC-1343[CCBC-1343]:
  Do not schedule NMV immediately by default and use retry strategy instead.

* https://issues.couchbase.com/browse/CCBC-1335[CCBC-1335]:
  Fix next timeout computation on requesting config using `operation_timeout` instead of `config_node_timeout`
...
* https://issues.couchbase.com/browse/CCBC-1331[CCBC-1331]:
  Fix error at bootstrap callback, now it returns original error code, that caused the bootstrap failure.
...
* https://issues.couchbase.com/browse/CCBC-1324[CCBC-1324]:
  define HTTP type for Eventing management
