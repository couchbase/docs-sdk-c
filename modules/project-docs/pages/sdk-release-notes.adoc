...
Version 3.0.3 is the fifth release of the 3.0 series, bringing enhancements and bugfixes over the last stable release.
...
Implement scope qualifier for queries

* https://issues.couchbase.com/browse/CCBC-1301[CCBC-1301]:
Expose cmake option to help dissecting TLS traffic
