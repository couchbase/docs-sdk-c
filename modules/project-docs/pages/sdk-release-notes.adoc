...
* https://issues.couchbase.com/browse/CCBC-1540[CCBC-1540]:
  Bundle Capella CA certificate with SDK.

Fixes:

* https://issues.couchbase.com/browse/CCBC-1538[CCBC-1538]:
  Use 64-bit integer to store time in IOCP plugin

* https://issues.couchbase.com/browse/CCBC-1526[CCBC-1526]:
  Do not validate length of collection specifier. Length will be checked on the server-side.

* https://issues.couchbase.com/browse/CCBC-1527[CCBC-1527]:
  Pillowfight: deallocate all memory during shutdown
