...
* https://issues.couchbase.com/browse/CCBC-1472[CCBC-1472]: Ensure strict JSON parsing mode for query meta.

* https://issues.couchbase.com/browse/CCBC-1494[CCBC-1494]: Disconnect logger after `lcb_destroy` invoked to avoid double free errors.

* https://issues.couchbase.com/browse/CCBC-1457[CCBC-1457]: improve error message when server enforces encryption

* https://issues.couchbase.com/browse/CCBC-1489[CCBC-1489]: Fixed get_and_touch to use the correct expiry.

* https://issues.couchbase.com/browse/CCBC-1487[CCBC-1487]: Fixed `retryq` erasing already sent packets.

* https://issues.couchbase.com/browse/CCBC-1488[CCBC-1488]: Fixed incorrect refcounting in `Connstart`.

* https://issues.couchbase.com/browse/CCBC-1479[CCBC-1479]: Initialize fields of custom tracer struct.

* https://issues.couchbase.com/browse/CCBC-1478[CCBC-1478]: Do not retry successful query with empty result.

* https://issues.couchbase.com/browse/CCBC-1216[CCBC-1216]: Implement user impersonation API
