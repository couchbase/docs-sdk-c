...
* https://issues.couchbase.com/browse/CCBC-1394[CCBC-1395]:
  Do not expose `LCB_ERR_BUCKET_NOT_FOUND` in operation callbacks. Instead retry operation automatically until timeout.

* https://issues.couchbase.com/browse/CCBC-1373[CCBC-1373]:
  Do not send collection in the key. Sending collection specification in both key and body breaks protocol, and the
