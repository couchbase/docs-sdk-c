...
https://docs.couchbase.com/sdk-api/couchbase-c-client-3.0.2[API Reference]
...
* https://issues.couchbase.com/Version 3.0.1 is the second release of the 3.0 series, bringing enhancements and bugfixes over the last stable release.

browse/CCBC-1188[CCBC-1188]:
