...
Note: CentOS 7 RPMs depend on OpenSSL 1.1, which is available in EPEL. Make sure that `epel-release` package installed
in the system (`yum install epel-release`).
