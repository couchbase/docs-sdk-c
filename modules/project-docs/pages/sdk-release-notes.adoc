...
* https://issues.couchbase.com/browse/CCBC-1188[CCBC-1188]: cbc-pillowfight: fixed `--collection` switch.

* https://issues.couchbase.com/browse/CCBC-1173[CCBC-1173]: Fix exporting `lcb_cmdquery_consistency_token_for_keyspace`

* https://issues.couchbase.com/browse/CCBC-1168[CCBC-1168]: expose `max_parallelism` for query

* https://issues.couchbase.com/browse/CCBC-1171[CCBC-1171]: expose `profile` option for query

* https://issues.couchbase.com/browse/CCBC-1170[CCBC-1170]: expose `scan_wait` option for query

* https://issues.couchbase.com/browse/CCBC-1159[CCBC-1159]: Fix error codes for Management API

* https://issues.couchbase.com/browse/MB-37768[MB-37768]: Don't override `CMAKE_INSTALL_RPATH`.

* https://issues.couchbase.com/browse/CCBC-1208[CCBC-1208]: Add a fail-fast retry strategy.

* https://issues.couchbase.com/browse/CCBC-1209[CCBC-1209]: Rename functions of embedded `http_parser` to avoid name clash.
