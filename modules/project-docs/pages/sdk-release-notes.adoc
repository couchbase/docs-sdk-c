...
Retry bootstrap on missing bucket until timeout. Bootstrap timeout controlled by "config_total_timeout" in connection string or LCB_CNTL_CONFIGURATION_TIMEOUT

* https://issues.couchbase.com/browse/CCBC-1190[CCBC-1190]:
Fix automatic retries for temporary failures from the server.

* https://issues.couchbase.com/browse/CCBC-1158[CCBC-1158]:
Fix retrying on unknown collection.

* https://issues.couchbase.com/browse/CCBC-1254[CCBC-1254]:
Use separate option for default timeout of analytics queries (connection string "analytics_timeout").

* https://issues.couchbase.com/browse/CCBC-1178[CCBC-1178]:
Do not allow to set CAS for upsert and insert operations

* https://issues.couchbase.com/browse/CCBC-1156[CCBC-1156]:
Fix enum value for analytics type of HTTP request

* https://issues.couchbase.com/browse/CCBC-1251[CCBC-1251]:
No longer log error when using GCCCP on pre-6.5
...
Tracing thresholds for query and search in connection strings. Now they are correctly spelled as tracing_threshold_search and tracing_threshold_query.

* https://issues.couchbase.com/browse/CCBC-1187[CCBC-1187]:
Ensure lcb_respexists_is_found does not true for deleted documents.
