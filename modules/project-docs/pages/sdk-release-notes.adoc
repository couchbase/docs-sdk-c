...
* https://issues.couchbase.com/browse/CCBC-1311[CCBC-1311]:
  Implement `create_as_deleted` subdoc feature.

* https://issues.couchbase.com/browse/CCBC-1263[CCBC-1263]:
  Update ping to report analytics as analytics service instead of query
...
* https://issues.couchbase.com/browse/CCBC-1262[CCBC-1262]:
  Add accessor for `report_id` in ping report

* https://issues.couchbase.com/browse/CCBC-1176[CCBC-1176]:
  Rename "scope" to "namespace" in ping report (also deprecate `lcb_respping_result_scope` in favour to `lcb_respping_result_namespace`)
...
* https://issues.couchbase.com/browse/CCBC-1194[CCBC-1194]:
  Add extra checks for socket state in `lcb_diag` to avoid invalid access issues
...
* https://issues.couchbase.com/browse/CCBC-1316[CCBC-1316]:
  Fix two-step bootstrap (`lcb_connect` + `lcb_open`) for memcached bucket.
