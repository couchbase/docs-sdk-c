...
① The C SDK 3.3.12+ is compatible with Server 7.6 - 8.0, but does not contain APIs for some of the 
...
At time of writing (December 2023):  15 (Sequoia), 14 (Sonoma), and 13 (Ventura).
...
// removed deprecated transactions from the table
////
...
include::8.0@sdk:shared:partial$api-version.adoc[tag=api-version]
