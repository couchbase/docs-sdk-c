...
At time of release, the Couchbase 3.2 C SDK is fully compatible with Couchbase Capella, our fully-hosted database-as-a-service.
...
* Debian 9 (_Stretch_), 10 (_Buster_), & 11 (_Bullseye_).
...
2+| Not Supported
2+| Since 3.0 & Server 6.6footnote:[Using the separate {cpp} Transactions Library, which automatically installs libcouchbase.]
