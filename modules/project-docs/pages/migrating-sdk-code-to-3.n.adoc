...
include::6.5@sdk:partial$shared:migration.adoc[tag=terms2]


include::6.5@sdk:partial$shared:migration.adoc[tag=new]


include::6.5@sdk:partial$shared:migration.adoc[tag=lang]
