...
:description: Couchbase C++ Distributed ACID Transactions is distributed as a separate library for the C SDK.
...
See the xref:{version-common}@server:learn:data/transactions.adoc[Distributed ACID Transactions concept doc] in the server documentation for details of how Couchbase implements transactions.
