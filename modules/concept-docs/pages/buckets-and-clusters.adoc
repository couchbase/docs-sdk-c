...
To create a bucket using the REST API :

[source,c]
----
include::devguide:example$c/management-bucket-create.cc[tag=create-bucket]
----

To delete a bucket using the REST API :

[source,c]
----
include::devguide:example$c/management-bucket-drop.cc[tag=delete-bucket]
----
