...
For a discussion of errors affecting multi-document ACID transactions, see xref:1.0@cxx-txns::distributed-acid-transactions-from-the-sdk.adoc#error-handling[our documentation on transactions from the Java SDK].
cxx-txns/current/distributed-acid-transactions-from-the-sdk.html#error-handling
