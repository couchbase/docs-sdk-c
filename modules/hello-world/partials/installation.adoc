...
[source,console]
----
$ curl -O https://packages.couchbase.com/clients/c/libcouchbase-3.3.8_centos7_x86_64.tar
----

[source,console]
----
$ tar xf libcouchbase-3.3.8_centos7_x86_64.tar
----

[source,console]
----
$ cd libcouchbase-3.3.8_centos7_x86_64
----

[source,console]
----
$ sudo yum install -y libcouchbase3{-tools,-libevent,}-3.3.8*.rpm libcouchbase-devel-*.rpm
----
...
> ...
> Installed:
>   libcouchbase-devel.x86_64 0:3.3.8-1.el7
>   libcouchbase3.x86_64 0:3.3.8-1.el7
>   libcouchbase3-libevent.x86_64 0:3.3.8-1.el7
>   libcouchbase3-tools.x86_64 0:3.3.8-1.el7
> ...
>
> Complete!
----
