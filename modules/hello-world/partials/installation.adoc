...
The following commands show steps to execute on *CentOS 7* box, for other RPM-based distributions -- such as Amazon Linux 2 -- the steps are the same or similar.
