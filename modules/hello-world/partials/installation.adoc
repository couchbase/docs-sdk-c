...
| Enterprise Linux 10 | 64-bit | \https://packages.couchbase.com/clients/c/repos/rpm/el10/x86_64
|===
...
Binaries are linked from the release notes page for each libcouchbase release --
we strongly recommend xref:project-docs:sdk-release-notes.adoc#latest-release[downloading the latest release].
