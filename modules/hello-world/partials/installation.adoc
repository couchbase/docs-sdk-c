...
[source,console]
----
$ sudo yum install -y libcouchbase3{-tools,-libevent,}-3.1.1*.rpm libcouchbase-devel-*.rpm
----
...
> ...
> Installed:
>   libcouchbase3-tools-3.1.1-1.el8.x86_64
>   libcouchbase3-libevent-3.1.1-1.el8.x86_64
>   libcouchbase3-3.1.1-1.el8.x86_64
>   libcouchbase-devel-3.1.1-1.el8.x86_64
>
> Complete!
----
====
...
[source,console]
----
$ curl -O https://packages.couchbase.com/clients/c/libcouchbase-3.1.1_debian10_buster_amd64.tar
----

[source,console]
----
$ tar xf libcouchbase-3.1.1_debian10_buster_amd64.tar
----

[source,console]
----
$ cd libcouchbase-3.1.1_debian10_buster_amd64
----
...
[source,console]
----
$ sudo dpkg -i libcouchbase3{-tools,-libevent,}_3.1.1*.deb libcouchbase-dev*.deb
...
> Preparing to unpack libcouchbase3-tools_3.1.1-1_amd64.deb ...
> Unpacking libcouchbase3-tools (3.1.1-1) ...
> Selecting previously unselected package libcouchbase3-libevent:amd64.
> Preparing to unpack libcouchbase3-libevent_3.1.1-1_amd64.deb ...
> Unpacking libcouchbase3-libevent:amd64 (3.1.1-1) ...
> Selecting previously unselected package libcouchbase3:amd64.
> Preparing to unpack libcouchbase3_3.1.1-1_amd64.deb ...
> Unpacking libcouchbase3:amd64 (3.1.1-1) ...
> Selecting previously unselected package libcouchbase-dev:amd64.
> Preparing to unpack libcouchbase-dev_3.1.1-1_amd64.deb ...
> Unpacking libcouchbase-dev:amd64 (3.1.1-1) ...
> Setting up libcouchbase3:amd64 (3.1.1-1) ...
> Setting up libcouchbase-dev:amd64 (3.1.1-1) ...
> Setting up libcouchbase3-libevent:amd64 (3.1.1-1) ...
> Setting up libcouchbase3-tools (3.1.1-1) ...
