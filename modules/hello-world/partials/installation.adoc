...
[source,console]
----
$ curl -O https://packages.couchbase.com/clients/c/libcouchbase-3.1.0_centos8_x86_64.tar
----

[source,console]
----
$ tar xf libcouchbase-3.1.0_centos8_x86_64.tar
----

[source,console]
----
$ cd libcouchbase-3.1.0_centos8_x86_64
----

[source,console]
----
$ sudo yum install -y libcouchbase3{-tools,-libevent,}-3.1.0*.rpm libcouchbase-devel-*.rpm
----
...
> ...
> Installed:
>   libcouchbase3-tools-3.1.0-1.el8.x86_64
>   libcouchbase3-libevent-3.1.0-1.el8.x86_64
>   libcouchbase3-3.1.0-1.el8.x86_64
>   libcouchbase-devel-3.1.0-1.el8.x86_64
>
> Complete!
----
====
...
[source,console]
----
$ curl -O https://packages.couchbase.com/clients/c/libcouchbase-3.1.0_debian10_buster_amd64.tar
----

[source,console]
----
$ tar xf libcouchbase-3.1.0_debian10_buster_amd64.tar
----

[source,console]
----
$ cd libcouchbase-3.1.0_debian10_buster_amd64
----
...
[source,console]
----
$ sudo dpkg -i libcouchbase3{-tools,-libevent,}_3.1.0*.deb libcouchbase-dev*.deb
...
> Preparing to unpack libcouchbase3-tools_3.1.0-1_amd64.deb ...
> Unpacking libcouchbase3-tools (3.1.0-1) ...
> Selecting previously unselected package libcouchbase3-libevent:amd64.
> Preparing to unpack libcouchbase3-libevent_3.1.0-1_amd64.deb ...
> Unpacking libcouchbase3-libevent:amd64 (3.1.0-1) ...
> Selecting previously unselected package libcouchbase3:amd64.
> Preparing to unpack libcouchbase3_3.1.0-1_amd64.deb ...
> Unpacking libcouchbase3:amd64 (3.1.0-1) ...
> Selecting previously unselected package libcouchbase-dev:amd64.
> Preparing to unpack libcouchbase-dev_3.1.0-1_amd64.deb ...
> Unpacking libcouchbase-dev:amd64 (3.1.0-1) ...
> Setting up libcouchbase3:amd64 (3.1.0-1) ...
> Setting up libcouchbase-dev:amd64 (3.1.0-1) ...
> Setting up libcouchbase3-libevent:amd64 (3.1.0-1) ...
> Setting up libcouchbase3-tools (3.1.0-1) ...
...
To verify the client run *cbc version* (*cbc.exe version* on Windows). Below is the output from version 3.1.0 on CentOS 8. It shows version along with git commit numbers. Then it prints default directory where IO plugins installed and enumerates the currently installed and available plugins. After that it reports whether OpenSSL linked to this particular version of libcouchbase, and displays the version number if it is accessible.

[source,console]
----
$ cbc version
cbc:
  Runtime: Version=3.1.0, Changeset=ed8b57e731e04e2749393c8bed8f9eb88d5d663d
  Headers: Version=3.1.0, Changeset=ed8b57e731e04e2749393c8bed8f9eb88d5d663d
  Build Timestamp: 2021-03-03 12:18:24
