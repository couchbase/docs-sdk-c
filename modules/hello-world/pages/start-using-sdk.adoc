...
The 3.1 SDK is ready for the planned introduction of xref:concept-docs:collections.adoc[Collections] in a future release of the Couchbase Data Platform.
