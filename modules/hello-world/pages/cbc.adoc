...
:page-aliases: ROOT:webui-cli-access,server:developer-guide:retrieving,server:developer-guide:cli-overview
...
Web and command line interfaces to Couchbase Server are available. 
The cbc command line tools are a part of libcouchbase, with installation documented below, whilst Web console access is provided in Couchbase Server -- xref:#couchbase_web_console_document_&_query_access[see links]. 
...
You can use the Couchbase Web Console to view, edit, and create JSON documents up to 256KB in size -- see the 6.5@server:manage:manage-ui/manage-ui.adoc[Couchbase Web Console] in the Server docs.
