...
* {lcb_api_link}/md_doc_2cbc-n1qlback.html[cbc-n1qlback]:
...
You can use the Couchbase Web Console to view, edit, and create JSON documents up to 256KB in size -- see the xref:{version-common}@server:manage:manage-ui/manage-ui.adoc[Couchbase Web Console] in the Server docs.

You can also use the xref:{version-common}@server:tools:query-workbench.adoc[Query Workbench] to issue {sqlpp} (formerly N1QL) queries using the web console.
