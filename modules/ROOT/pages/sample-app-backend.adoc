...
You may want to look at our xref:2.10@c-sdk::start-using-sdk.adoc#hello-couchbase[Getting Started code example] first, to see a more complete code sample, with `#include`s.
