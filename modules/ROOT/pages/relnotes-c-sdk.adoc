...
The following examples download and install _couchbase-release_ repsitory, a C and C++ compiler, and the C SDK core (_libcouchbase2-core_), command line tools (_libcouchbase2-bin_), and the development tools
