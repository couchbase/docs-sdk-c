...
You will find several ways of working with counters https://docs.couchbase.com/sdk-api/couchbase-c-client-2.10.6/group__lcb-counter.html[in the API docs].
