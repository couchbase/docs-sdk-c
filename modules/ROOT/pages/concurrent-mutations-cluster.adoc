...
.Code samples
====
The examples used in this explanation are mostly C pseudo code, with a little Python, to keep things clear and brief.
After you have worked your way through this page, take a look at a complete, multithreaded example at xref:https://github.com/couchbaselabs/devguide-examples/blob/master/c/cas.cc[^]
====
...
Retrieving the document again (and showing in Python for brevity) yields:
