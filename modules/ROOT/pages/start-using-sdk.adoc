...
See xref:relnotes-java-sdk.adoc[Installation and Release Notes] section for details.

== Installing from Source Code

You may install the library from source code, either via a repository checkout or using a release tarball (download links may be found at xref:relnotes-java-sdk.adoc[Installation and Release Notes].
...
Information on new features, fixes, known issues as well as information on how to install older release versions is available in the xref:relnotes-java-sdk.adoc[release notes].
