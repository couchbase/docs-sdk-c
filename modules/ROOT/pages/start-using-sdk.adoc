...
Windows binary packages can be found as downloads for each version listed on the xref:sdk-release-notes.adoc#latest-version[Release Notes and Archives page], 
...
Source archives can be found as a download for each version of the C SDK listed on the xref:sdk-release-notes.adoc#latest-version[Release Notes and Archives page], linked from the table in each Release Note.
