...
== IPv6
IPv6-only clusters have been allowed since Couchbase Data Platform 5.5, and for most networks the client will operate automatically with IPv4 or IPv6 networks without issue.
