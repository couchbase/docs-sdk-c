...
* https://issues.couchbase.com/browse/CCBC-1106[CCBC-1106]: Move log messages from IO manager to DEBUG level to reduce noise.

* https://issues.couchbase.com/browse/CCBC-1100[CCBC-1100]: Allow to ping operation to use direct URL

* https://issues.couchbase.com/browse/CCBC-939[CCBC-939]: Improve performance with tracing enabled by caching expensive calculations
...
* https://issues.couchbase.com/browse/CCBC-1059[CCBC-1059]: Fixed hostname truncation when using alternative network addresses.
...
* https://issues.couchbase.com/browse/CCBC-1109[CCBC-1109]: Fix retrying N1QL query on auth error. The library was trying to dereference NULL pointer when using dynamic authenticator with N1QL queries.

* https://issues.couchbase.com/browse/CCBC-1063[CCBC-1063]: Cache credentials provided by dynamic auth callback.
